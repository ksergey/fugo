...
[[nodiscard]] FUGO_FORCE_INLINE auto backend() -> detail::Backend* {
...
FUGO_FORCE_INLINE auto shouldLog(LogLevel value) noexcept -> bool {
...
/// Stop backend thread
FUGO_FORCE_INLINE void stopBackend() {
  backend()->stop();
}
